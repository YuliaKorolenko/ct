...
func CreateFilter(title string, authorId int64, published bool, time string) AdFilter {
	return AdFilter{Title: title, AuthorID: authorId, Published: published, Time: time}
}
